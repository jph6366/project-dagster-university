...
from dagster_essentials.assets import metrics, trips, zones, requests
...
metric_assets = dg.load_assets_from_modules(modules=[metrics],
                                            group_name="metrics",
                                            )
request_assets = dg.load_assets_from_modules(modules=[requests],
                                            group_name="requests",
                                            )
...
defs = dg.Definitions(
    assets=[*zones_assets, *trip_assets, *metric_assets, *request_assets],
    resources={
